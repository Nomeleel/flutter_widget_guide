...
| 方向更改 | [Orientation**Builder**](https://api.flutter.dev/flutter/widgets/OrientationBuilder-class.html) | LayoutBuilder | 👆旋转设备方向改变触发布局更新。注意: **并非是设备方向，只是长和宽发生了互换，导致原先定义的正方向失效了。** 此Widget依赖于LayoutBuilder，只是更关注于前面所说的方向。 |
